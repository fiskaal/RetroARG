...
namespace TopDownShooter
{
    public class PlayerController : MonoBehaviour
    {
        ...
        [Header("Use axis to shoot and rotate player")]
        public bool UseAxisToRotate = false;
        ...
        public bool GetSlowFallValue()
        {
            ...
            return Input.GetButtonDown("Glide");
        }

        public bool GetDropWeaponValue()
        {
            return Input.GetButtonDown("DropItem");
        }
        ...
        public Vector3 GetMouseDirection()
        {
            ...
            }else if (Input.GetButtonDown("Fire") && Physics.Raycast(newRay, out groundHit, 1000, GroundLayer))
            {
                var playerToMouse = groundHit.point - transform.position;
