...
public class EnemyMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        else
        {
            ...
            {
                if (Vector3.Distance(pc.transform.position, transform.position) < chaseDistance)
                {
    ...
    public void OnChase()
    {
        lookTarget = pc.transform.position;
        ...
        if (Vector3.Distance(pc.transform.position, transform.position) > looseDistance)
        {
